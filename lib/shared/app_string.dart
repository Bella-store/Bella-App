...
class AppString {
  ...
  static String notification(BuildContext context) => 'notification'.tr(context);
  ...
  static String termsAndConditions(BuildContext context) => 'termsAndConditions'.tr(context);
  ...
  static String onboardingTitle1(BuildContext context) => 'onboardingTitle1'.tr(context);
  static String onboardingSubtitle1(BuildContext context) => 'onboardingSubtitle1'.tr(context);
  static String onboardingTitle2(BuildContext context) => 'onboardingTitle2'.tr(context);
  static String onboardingSubtitle2(BuildContext context) => 'onboardingSubtitle2'.tr(context);
  static String onboardingTitle3(BuildContext context) => 'onboardingTitle3'.tr(context);
  static String onboardingSubtitle3(BuildContext context) => 'onboardingSubtitle3'.tr(context);
// login Screen --------------------------------------------------------------
  ...
  static String plzEnterEmail(BuildContext context) => 'plzEnterEmail'.tr(context);
  static String password(BuildContext context) => 'password'.tr(context);
  static String plzEnterPassword(BuildContext context) => 'plzEnterPassword'.tr(context);
  static String login(BuildContext context) => 'login'.tr(context);
  static String forgotPassword(BuildContext context) => 'forgotPassword'.tr(context);
  static String dontHaveAnAccount(BuildContext context) => 'dontHaveAnAccount'.tr(context);
  static String or(BuildContext context) => 'or'.tr(context);
  static String continueWithFacebook(BuildContext context) => 'continueWithFacebook'.tr(context);
  static String continueWithGoogle(BuildContext context) => 'continueWithGoogle'.tr(context);
  static String continueWithApple(BuildContext context) => 'continueWithApple'.tr(context);
// signUp Screen ----------------------------------------------------------
  static String signUp(BuildContext context) => 'signUp'.tr(context);
  static String alreadyHaveAnAccount(BuildContext context) => 'alreadyHaveAnAccount'.tr(context);
  ...
  static String plzEnterUsername(BuildContext context) => 'plzEnterUsername'.tr(context);
//  Home Screen -----------------------------------------------------
  ...
  static String dreamFurniture(BuildContext context) => 'dreamFurniture'.tr(context);
...
// product details screen ------------------------------------------------------
  static String productDetails(BuildContext context) => 'productDetails'.tr(context);
  static String description(BuildContext context) => 'description'.tr(context);
  static String availableInStock(BuildContext context) => 'availableInStock'.tr(context);
...
// my order screen---------------------------------------------------------
  ...
  static String addPaymentMethod(BuildContext context) => 'addPaymentMethod'.tr(context);
  static String addCard(BuildContext context) => 'addCard'.tr(context);
  static String cardHolderName(BuildContext context) => 'cardHolderName'.tr(context);
  static String expiryDate(BuildContext context) => 'expiryDate'.tr(context);
  static String pleaseEnterCardHolderName(BuildContext context) => 'pleaseEnterCardHolderName'.tr(context);
  static String pleaseEnterCardNumber(BuildContext context) => 'pleaseEnterCardNumber'.tr(context);
  static String cardNumber(BuildContext context) => 'cardNumber'.tr(context);
  static String pleaseEnterValidCard(BuildContext context) => 'pleaseEnterValidCard'.tr(context);
  static String exirationDate(BuildContext context) => 'exirationDate'.tr(context);
  static String pleaseEnterExpirationDate(BuildContext context) => 'pleaseEnterExpirationDate'.tr(context);

  // favorites screen -------------------------------------------------------------
  static String favorites(BuildContext context) => 'Favorites'.tr(context);
  static String addAllToMyCart(BuildContext context) => 'addAllToMyCart'.tr(context);
